...
import '../css/ClientQuestionnaireTeamSplit.css';
...
function ClientQuestionnaireTeamSplit() {
    ...
    const navQues = controls => {
        navigate('/clientQuestionaire', { state: { clientID: clientID, controls: controls, index: 0 } });
    }

    return (
        <div>
            <ClientTopNavHome company={"TEAM ("+team+")"}></ClientTopNavHome>
            <div className='web_clientside_team_split'>
                ...
                <div className='web_clientside_team_split_view_flex_area'>
                    <ImageList cols={1} rowHeight={115} style={{ width: "100vw" }}>
                        {
                            dataList.map((data, index) => (
                                <div className='web_clientside_team_split_view_flex_area_div'>
...
export default ClientQuestionnaireTeamSplit;